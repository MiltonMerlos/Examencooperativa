...
class VentaController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $asociado = Asociado::pluck('nombre', 'id');
        $usuario = User::pluck('name', 'id');
            return view('ventas.create', compact('producto','asociado','usuario'));
    }
    ...
    public function edit($id)
    {
        ...
        $asociado = Asociado::pluck('nombre', 'id');
        $usuario = User::pluck('name', 'id');
          return view('ventas.edit', compact('producto','asociado','usuario','venta'));
    }
